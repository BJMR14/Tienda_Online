                ...
                <div class="d-flex">
                  <div class="dropdown mr-1 ml-md-auto">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                      ...
                      <a class="dropdown-item" href="#">Productos de belleza</a>
...
<li class="mb-1"><a href="#" class="d-flex"><span>Productos de Belleza
</span> <span class="text-black ml-auto">(5,220)</span></a></li>
<li class="mb-1"><a href="#" class="d-flex"><span>Alimentos
</span> <span class="text-black ml-auto">(220)</span></a></li>
<li class="mb-1"><a href="#" class="d-flex"><span>Productos de Limpieza
</span> <span class="text-black ml-auto">(720)</span></a></li>
<li class="mb-1"><a href="#" class="d-flex"><span>Frutas y Verduras
</span> <span class="text-black ml-auto">(520)</span></a></li>
<li class="mb-1"><a href="#" class="d-flex"><span>Productos de Aseo Personal
</span> <span class="text-black ml-auto">(6,220)</span></a></li>
              </ul>
            </div>
