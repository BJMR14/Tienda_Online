...
<html lang="en">
  <head>
    <title>Compradores &mdash; Plantilla de comercio</title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.html" class="js-logo-clone">Compradoras</a>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
            <h1 class="mb-2">Encontrar tus zapatos perfectos</h1>
            ...
            <div class="nonloop-block-3 owl-carousel">
              ...
              <div class="item">
                <div class="block-4 text-center">
                  ...
                  <div class="block-4-text p-4">
                    <h3><a href="#">Coraterrrrrrrrrrrrr</a></h3>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <a href="#" class="block-6">
              ...
              <h3 class="font-weight-light  mb-0">Encontrar tus zapatos perfectos</h3>
              <p>Promo from  nuary 15 &mdash; 25, 2019</p>
            </a>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="block-5 mb-5">
              <h3 class="footer-heading mb-4">Contacto Informacion</h3>
              <ul class="list-unstyled">
